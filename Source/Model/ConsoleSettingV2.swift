...
struct ConsoleSettingSchemaV2: VersionedSchema {
    ...
    final class ConsoleSetting: Identifiable, Codable {
        ...
        var mouseCursorType0 : CursorType? = nil
        ...
        required init(from decoder: Decoder) throws {
            ...
            self.mouseCursorType0 = try container.decode(CursorType.self, forKey: .mouseCursorType0)
            
            self.windowFullScreenStarting = try container.decode(Bool.self, forKey: .windowFullScreenStarting)
        ...
        func encode(to encoder: Encoder) throws {
            ...
            try container.encode(mouseCursorType0, forKey: .mouseCursorType0)
            
            try container.encode(windowFullScreenStarting, forKey: .windowFullScreenStarting)
